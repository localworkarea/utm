(() => {
    ...
    function initSliders() {
        ...
        function adjustPagination() {
            ...
            var shiftAmount = 0;
            if (activeBulletOffset + activeBulletWidth > containerWidth) shiftAmount = activeBulletOffset + activeBulletWidth - containerWidth + 10; else if (activeBulletOffset < 0) shiftAmount = activeBulletOffset - 10;
            ...
            if (activeBulletLeft < 0) paginationWrapper.scrollLeft += activeBulletLeft; else if (activeBulletRight > paginationWrapperWidth) paginationWrapper.scrollLeft += activeBulletRight - paginationWrapperWidth;
        }
        if (document.querySelector(".products-about__slider")) new core(".products-about__slider", {
        ...
        if (document.querySelector(".devices-slider__slider")) new core(".devices-slider__slider", {
        ...
        if (document.querySelector(".projectors-slider__slider")) new core(".projectors-slider__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".lamps-slider__slider")) new core(".lamps-slider__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
